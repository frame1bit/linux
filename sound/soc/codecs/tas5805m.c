...
// Book 0xaa
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x24 },
    { 0x18, 0x08 }, //  Biquad -  BQ1 Left   -     Filter: Equalizer (Q Factor)  Frequency: 100 Hz  Gain: 9dB  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x19, 0x11 },
    { 0x1a, 0x15 },
    { 0x1b, 0xff },
    { 0x1c, 0xf0 },
    ...
    { 0x2a, 0xca },
    { 0x2b, 0xdd },
    { 0x2c, 0x0c }, //  Biquad -  BQ2 Left   -     Filter: Equalizer (Q Factor)  Frequency: 11994.54 Hz  Gain: 8.14dB  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x2d, 0x6c },
    { 0x2e, 0x1f },
    { 0x2f, 0x64 },
    { 0x30, 0xf8 },
    ...
    { 0x3e, 0x43 },
    { 0x3f, 0x10 },
    { 0x40, 0x08 }, //  Biquad -  BQ3 Left   -     Filter: Equalizer (Q Factor)  Frequency: 994.13 Hz  Gain: 3.01dB  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x41, 0x25 },
    { 0x42, 0x29 },
    { 0x43, 0xb2 },
    { 0x44, 0xf0 },
...
static void tas5805m_dummy_write(struct work_struct *work)
{
    struct tas5805m_priv *tas5805m = container_of(work,
						struct tas5805m_priv,
						dummy_write_work);
    ...
    dev_info(component->dev, "Do Scheduling task!\n");
			    ...
			    struct snd_soc_dai *dai)
{
	...
	dev_info(component->dev, "TAS5805m trigger (%d)\n", cmd);
	...
	case SNDRV_PCM_TRIGGER_PAUSE_RELEASE:
        ...
        // c_e: disable, change to the patch methode
        /*
		send_cfg(rm, tas5805m->dsp_cfg_data,
			tas5805m->dsp_cfg_len);
        */
		tas5805m->is_powered = true;
        tas5805m->is_muted = false;
		break;
    ...
    schedule_work(&tas5805m->dummy_write_work);
...
static int tas5805m_i2c_probe(struct i2c_client *i2c)
{
	...
	dev_info(dev, "I2C check functionality Success !\n");
	...
	dev_info(dev, "Assume patch successfully !\n");

    tas5805m->is_powered = true;

    /* Set/clear digital soft-mute */
    regmap_write(regmap, REG_PAGE, 0x00);
	regmap_write(regmap, REG_BOOK, 0x00);
	regmap_write(regmap, REG_DEVICE_CTRL_2, DCTRL2_MUTE | DCTRL2_MODE_PLAY);

    INIT_WORK(&tas5805m->dummy_write_work, tas5805m_dummy_write);
